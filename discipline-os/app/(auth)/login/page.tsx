...
export default function LoginPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setError(err.response?.data?.message || err.response?.data?.error || "Failed to log in. Please check your credentials.");
        } finally {
            setIsLoading(false);
        }
    };
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-[#111214] p-4">
            <div className="w-full max-w-[400px] space-y-6">
                ...
                <Card className="p-8">
                    <h2 className="text-xl font-bold text-[#E8E6E1] mb-6">Welcome Back</h2>
